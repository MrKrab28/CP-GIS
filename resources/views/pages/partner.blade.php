<x-layout>
   <x-hero title="PARTNERSHIP">

   </x-hero>

    <section id="partnership" class="constructions section">

        <!-- Section Title -->

        <x-section-title title="Partnership">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="card-item">
                        <div class="row">
                            <div class="col-xl-5">
                                <div class="card-bg"><img src="{{ asset('assets/images/ptsej.jpg') }}" alt="">
                                </div>
                            </div>
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="card-item">
                        <div class="row">
                            <div class="col-xl-5">
                                <div class="card-bg"><img src="{{ asset('assets/images/kantah.jpg') }}" alt="">
                                </div>
                            </div>
                            <div class="col-xl-7 d-flex align-items-center">
                                <div class="card-body">
